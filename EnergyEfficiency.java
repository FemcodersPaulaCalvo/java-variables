public class EnergyEfficiency {
    public static void main(String[] args) {
        ...
        System.out.println("Una calificación " + A + " es muy buena.");

        //Reemplaza <good> concatenando el String con la variable creada. 
        System.out.println("Una calificación " + B + " es buena.");
        
        //Reemplaza <fairly_good> concatenando el String con la variable creada. 
        System.out.println("Una calificación " + C + " es medianamente buena.");
        ...
        System.out.println("Una calificación " + F + " es mala.");

        //Reemplaza <very_bad> concatenando el String con la variable creada.
        System.out.println("Una calificación " + G + " es muy mala.");
