public class Cakes {
    public static void main(String[] args) {
        ...
        double doubleNum = (double)cake / people;
        System.out.println("Valor original de double: " + doubleNum);
        //Convierte double a int
        //Escribe aquí tu código
        System.out.println("Valor convertido de double a int: " + (int)doubleNum);

        //Declara y asigna un valor a una variable int
        //Escribe aquí tu código
        int intNum = 3;
        System.out.println("Valor original de int: " + intNum);

        //Convierte int a double
        //Escribe aquí tu código
        System.out.println("Valor convertido de int a double: " + (double)intNum);
